...
__jit_inline void
mips_ldi_c(jit_state_t _jit, mips_hc_t hc, jit_gpr_t r0, void *i0)
{
    long	ds = (long)i0;
...
__jit_inline void
mips_ldi_uc(jit_state_t _jit, mips_hc_t hc, jit_gpr_t r0, void *i0)
{
    long	ds = (long)i0;
...
__jit_inline void
mips_ldi_s(jit_state_t _jit, mips_hc_t hc, jit_gpr_t r0, void *i0)
{
    long	ds = (long)i0;
...
__jit_inline void
mips_ldi_us(jit_state_t _jit, mips_hc_t hc, jit_gpr_t r0, void *i0)
{
    long	ds = (long)i0;
...
__jit_inline void
mips_str_i(jit_state_t _jit, mips_hc_t hc, jit_gpr_t r0, jit_gpr_t r1)
{
    _SW(r1, r0, 0);
}

#define jit_sti_c(i0, r0)		mips_sti_b(_jit, i0, r0)
__jit_inline void
