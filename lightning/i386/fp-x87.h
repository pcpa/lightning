...
__jit_inline void
_x87_i686_fp_cmp(jit_gpr_t r0, jit_fpr_t f0, jit_fpr_t f1, int code)
{
    int		 rc;
    jit_gpr_t	 reg;
...
x87_ler_d(jit_gpr_t r0, jit_fpr_t f0, jit_fpr_t f1)
{
	...
	_x87_i386_fp_cmp(r0, f1, f0,	9, 0, -1);
}
...
x87_eqr_d(jit_gpr_t r0, jit_fpr_t f0, jit_fpr_t f1)
{
	...
	_x87_i386_fp_cmp(r0, fr0, fr1,	8, 0x45, -X86_CC_E);
}
...
x87_ger_d(jit_gpr_t r0, jit_fpr_t f0, jit_fpr_t f1)
{
	...
	_x87_i386_fp_cmp(r0, f0, f1,	9, 0, -1);
}
...
x87_ner_d(jit_gpr_t r0, jit_fpr_t f0, jit_fpr_t f1)
{
	...
	_x87_i386_fp_cmp(r0, fr0, fr1,	8, 0x45, -X86_CC_NE);
}
...
x87_unltr_d(jit_gpr_t r0, jit_fpr_t f0, jit_fpr_t f1)
{
	...
	_x87_i386_fp_cmp(r0, f0, f1,	9, 0, 0);
}
...
x87_ltgtr_d(jit_gpr_t r0, jit_fpr_t f0, jit_fpr_t f1)
{
	...
	_x87_i386_fp_cmp(r0, fr0, fr1,	15, 0, -1);
}
...
x87_uneqr_d(jit_gpr_t r0, jit_fpr_t f0, jit_fpr_t f1)
{
	...
	_x87_i386_fp_cmp(r0, fr0, fr1,	15, 0, 0);
}
...
x87_ungtr_d(jit_gpr_t r0, jit_fpr_t f0, jit_fpr_t f1)
{
	...
	_x87_i386_fp_cmp(r0, f1, f0,	9, 0, 0);
}
...
x87_ordr_d(jit_gpr_t r0, jit_fpr_t f0, jit_fpr_t f1)
{
	...
	_x87_i386_fp_cmp(r0, fr0, fr1,	11, 0, -1);
}
...
x87_unordr_d(jit_gpr_t r0, jit_fpr_t f0, jit_fpr_t f1)
{
	...
	_x87_i386_fp_cmp(r0, fr0, fr1,	11, 0, 0);
}
...
__jit_inline void
_x87_i686_fp_bcmp(jit_insn *label, jit_fpr_t f0, jit_fpr_t f1, int code)
{
    if (f0 == _ST0)
	FUCOMIr(f1);
    else {
