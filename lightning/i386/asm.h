...
__jit_inline void
_i_X(int op, long md, jit_gpr_t rb, jit_gpr_t ri, long ms)
{
    if (ri == _NOREG) {
	if (rb == _NOREG) {
#if __WORDSIZE == 32
...
__jit_inline void
_r_X(jit_gpr_t rd, long md, jit_gpr_t rb, jit_gpr_t ri, long ms)
{
    _i_X((int)_rA(rd), md, rb, ri, ms);
}

__jit_inline void
_f_X(jit_fpr_t rd, long md, jit_gpr_t rb, jit_gpr_t ri, long ms)
{
