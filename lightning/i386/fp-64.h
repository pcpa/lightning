...
__jit_inline void
jit_ldxi_f(jit_fpr_t f0, jit_gpr_t r0, jit_idx_t i0)
{
    sse_ldxi_f(f0, r0, i0);
}
...
__jit_inline void
jit_extr_l_f(jit_fpr_t f0, jit_gpr_t r0)
{
    sse_extr_l_f(f0, r0);
}
...
__jit_inline void
jit_extr_l_d(jit_fpr_t f0, jit_gpr_t r0)
{
    sse_extr_l_d(f0, r0);
}
...
__jit_inline void
jit_rintr_f_l(jit_gpr_t r0, jit_fpr_t f0)
{
    sse_rintr_f_l(r0, f0);
}
...
__jit_inline void
jit_rintr_d_l(jit_gpr_t r0, jit_fpr_t f0)
{
    sse_rintr_d_l(r0, f0);
}
...
__jit_inline void
jit_roundr_f_l(jit_gpr_t r0, jit_fpr_t f0)
{
    sse_roundr_f_l(r0, f0);
}
...
__jit_inline void
jit_roundr_d_l(jit_gpr_t r0, jit_fpr_t f0)
{
    sse_roundr_d_l(r0, f0);
}
...
__jit_inline void
jit_truncr_f_l(jit_gpr_t r0, jit_fpr_t f0)
{
    sse_truncr_f_l(r0, f0);
}
...
__jit_inline void
jit_truncr_d_l(jit_gpr_t r0, jit_fpr_t f0)
{
    sse_truncr_d_l(r0, f0);
}
...
__jit_inline void
jit_floorr_f_l(jit_gpr_t r0, jit_fpr_t f0)
{
    sse_floorr_f_l(r0, f0);
}
...
__jit_inline void
jit_floorr_d_l(jit_gpr_t r0, jit_fpr_t f0)
{
    sse_floorr_d_l(r0, f0);
}
...
__jit_inline void
jit_ceilr_f_l(jit_gpr_t r0, jit_fpr_t f0)
{
    sse_ceilr_f_l(r0, f0);
}
...
__jit_inline void
jit_ceilr_d_l(jit_gpr_t r0, jit_fpr_t f0)
{
    sse_ceilr_d_l(r0, f0);
}
