...
typedef enum {
    tok_eof = -1,	tok_type,	tok_symbol,	tok_int,
    tok_float,		tok_string,	tok_oparen,	tok_cparen,
    tok_obrack,		tok_cbrack,	tok_obrace,	tok_cbrace,
    tok_semicollon,	tok_collon,	tok_comma,	tok_dot,
    tok_arrow,		tok_ellipsis,	tok_set,	tok_andset,
    tok_orset,		tok_xorset,	tok_lshset,	tok_rshset,
    tok_addset,		tok_subset,	tok_mulset,	tok_divset,
    tok_remset,		tok_andand,	tok_oror,	tok_lt,
    tok_le,		tok_eq,		tok_ge,		tok_gt,
    tok_ne,		tok_and,	tok_or,		tok_xor,
    tok_lsh,		tok_rsh,	tok_add,	tok_sub,
    tok_mul,		tok_div,	tok_rem,	tok_inc,
    tok_dec,		tok_postinc,	tok_postdec,	tok_plus,
    tok_neg,		tok_not,	tok_com,	tok_pointer,
    tok_address,	tok_sizeof,	tok_question,	tok_if,
    tok_else,		tok_goto,	tok_return,	tok_switch,
    tok_case,		tok_default,	tok_break,	tok_for,
    tok_do,		tok_while,	tok_continue,	tok_signed,
    tok_unsigned,	tok_struct,	tok_union,	tok_typedef,
    tok_list,		tok_expr,	tok_stat,	tok_call,
    tok_code,		tok_label,	tok_vector,	tok_declexpr,
    tok_decl,		tok_function,
} token_t;
