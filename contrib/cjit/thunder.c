...
ejit_print(ejit_state_t *s)
{
	...
	p_i_p:
	    ...
	    case code_extr_i_l:		printf("extr_i_l");	goto i_i;
	    case code_extr_ui_ul:	printf("extr_ui_ul");	goto i_i;
	    ...
	    case code_roundr_d_l:	printf("roundr_d_l");	goto i_i;
	    case code_truncr_f_i:	printf("truncr_f_i");	goto i_i;
	    case code_truncr_f_l:	printf("truncr_f_l");	goto i_i;
	    case code_truncr_d_i:	printf("truncr_d_i");	goto i_i;
	    case code_truncr_d_l:	printf("truncr_d_l");	goto i_i;
	    case code_floorr_f_i:	printf("floorr_f_i");	goto i_i;
	    case code_floorr_f_l:	printf("floorr_f_l");	goto i_i;
	    case code_floorr_d_i:	printf("floorr_d_i");	goto i_i;
	    case code_floorr_d_l:	printf("floorr_d_l");	goto i_i;
	    case code_ceilr_f_i:	printf("ceilr_f_i");	goto i_i;
	    case code_ceilr_f_l:	printf("ceilr_f_l");	goto i_i;
	    case code_ceilr_d_i:	printf("ceilr_d_i");	goto i_i;
	    case code_ceilr_d_l:	printf("ceilr_d_l");	goto i_i;
